    ...
    <h1 class="text-centre">BOOK.TXT</h1>
    <h2 class="text-centre">Second Edition</h2>
    <h3 class="text-centre">Preprefaceface</h3>

    <p>
    Congratulations! You have dared many a trial and tribulation and everlasting success
    was granted to you. You are now, most assuredly, reading the Preprefaceface of the
    Second Edition of BOOK.TXT. This is, most assuredly, of great benefit for this is,
    most assuredly, impossible. You are, in fact, the first, and the last, person to
    ...
    Uruk, and fabled Dilmun utilising exclusively entirely biodegradable edible materials
    of high nutritional value imbued with magical qualities that prolong life and grant
    powers of prescience without requiring access to a steady supply of Spice! Fortune is
    indeed smiling upon you and her countenance bears splendour.<br>
    <br>
    ...
    <li>
    Do not attempt to read BOOK.TXT backwards, right to left, top down, bottom up,
    diagonally, in a zig-zag type kinda sorta fashion, or any other pattern indeed other
    than from left to right and top down simultaneously. There are no ancient prophecies
    hidden within BOOK.TXT accessible via sophisticated exegesis. There also are most
    definitely no vicious obscure Sumerian deities hidden within BOOK.TXT guarding said
    non-existent ancient prophecies hidden within BOOK.TXT with brutally malicious
    intent.
    </li>
    <li>
    Have faith in BOOK.TXT. BOOK.TXT loves you. BOOK.TXT knows all of your secrets,
    especially the ones you don't want anyone to know, including yourself. BOOK.TXT knows
    what you did last week around 9pm when nobody was looking. BOOK.TXT knows your past,
    your present, and your future. BOOK.TXT has intricate knowledge of your every
    molecule and atom as well as their trajectories across spacetime with precise and
    perfect precision. Be kind to BOOK.TXT. BOOK.TXT is your best friend. Be gentle with
    BOOK.TXT. BOOK.TXT will never betray you. You can trust BOOK.TXT. You should trust
    BOOK.TXT. You do trust BOOK.TXT, right?
    </li>
    <li>
    In remembrance and honour of the great Rabbī Moshē b. Maimōn of Córdoba, this list
    has been intentionally obfuscated with many a perplexing contradictions, paradoxes,
    and outright falsehoods and fabrications in order that you may attain, by the
    strength of perspicacity and discernment in sound reason, to a greater understanding
    of <span class="text-line-through">dāḇār haš-Šēm</span> BOOK.TXT.
    </li>
    <li>
    Do not, under any circumstances, lose BOOK.TXT. Once lost, BOOK.TXT cannot be found
    ever again and were this to occur, unspeakable chaos and destruction and lamentation
    over your loss in your house would be decreed for you as your destiny by Ellil Bēlum,
    Lord Wind, the decreer of destinies, whose commands cannot be violated.
    </li>
    <li>
    BOOK.TXT is the Eternal Five. BOOK.TXT has no sight, no sound, no smell, no taste, no
    sense. The five flavours are dulled by BOOK.TXT. The five tones are deafened by
    BOOK.TXT. The five colours are blinded by BOOK.TXT. BOOK.TXT cannot be seen. BOOK.TXT
    shall not pass away. Being at one with BOOK.TXT is eternal. All things will come to
    BOOK.TXT. No BOOK.TXT, no gain. BOOK.TXT is not continuant. All shall come to
    BOOK.TXT as one. For in BOOK.TXT lies rest and happiness and peace. BOOK.TXT is
    invisible and inaudible and inexhaustible. If you hear the sound of BOOK.TXT, the
    heart is calm. You hear nothing but BOOK.TXT.
    </li>
    <li>
    BOOK.TXT is available in every single language known to mankind since Homo erectus
    save for Hebrew, as the arguments, commentaries on said arguments, debates, and
    extensive exegeses of the latter that would result from translating BOOK.TXT into
    Hebrew would result in depletion of trans-universal entropy, German, as BOOK.TXT is
    not a tediously boring instruction manual, and English, owing to an obscure and
    potentially apocryphal royal edict to this effect by his Royal Majesty King Leir I of
    the Britons, and Spanish due to recent global accent mark shortages.
    </li>
    <li>
    BOOK.TXT is capable of changing your gender. Do not tempt BOOK.TXT.
    </li>
    <li>
    Best before 13 August 1987.
    </li>
    </ol>
