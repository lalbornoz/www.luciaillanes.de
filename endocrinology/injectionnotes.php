    <div class="div-box div-content">
      <h1 class="text-centre">Notes concerning HRT injections</h1>
      ...
      <p class="text-warning-black">
        ...
        Interindividual variability applies; doubly so owing to <a href="/<?php echo $inc_lang ?>/endocrinology/generalhrtnotes#hrt-general-hypophysis">General: familial pattern of hypophyseal dysregulation</a>.
      </p>
      ...
      <h2 class="text-centre" id="hrt-injection-protocol">Injection protocol</h2>
      ...
      <h2 class="text-centre" id="hrt-een-curve">Oestradiol Enanthate concentration curve parameters</h2>
