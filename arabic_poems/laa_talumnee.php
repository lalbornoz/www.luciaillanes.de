    <div class="div-box div-content">
      <h1 class="text-centre">
        Do not blame me for blame scarcely touches me<a href="#r2" class="a-reference">[2]</a><a href="#r3" class="a-reference">[3]</a>
      </h1>
      ...
      <p class="text-centre">
        ...
        إِنَّ في البَدءِ بَدءَ أَمريِ شَديدُ<br>
        <br>
      ...
      <div class="div-references">
        ...
        <br>
        <span id="r4">
          [4] alternatively: reward<br>
        </span>
        <br>
        <span id="r5">
          [5] viz. and thus: guide me, decree for me, for no guidance but yours now remains, and I am devoid of the very notion of guidance, and what you decree has been decreed, and what you have decreed shall be decreed, and I am devoid of being and existence in your the solitarity of your unitarity, etc. pp.<br>
        </span>
        <br>
        <span id="r6">
          [6] viz. if the promise of my beloved holds true and I may hold on to the truth of my beloved's promise and if the promise is that of truth, the sole truth, the sole ultimate, absolute reality of love and extinction in my beloved, etc. pp...<br>
        </span>
        <br>
        <span id="r7">
          [7] viz. ...then the principle, the basis, the beginning that I depart from towards my beloved on the grounds of my beloved's premise is that of sound, solid, firm, yet also severe, strong, and serious decree, command, instruction, guidance, order, power, authority, etc. pp.<br>
        </span>
        <br>
        <span id="r8">
