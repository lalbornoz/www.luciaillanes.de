    <div class="div-box div-content">
      ...
      <p class="text-centre">
        ...
        <br>
        لا تَلقَ دَهرَكَ إِلّا غَيرَ مُكتَرِثٍ<br>
        مادامَ يَصحَبُ فيهِ روحَكَ البَدَنُ<br>
        <br>
        فَما يَدومُ سُرورٌ ما سُرِرتَ بِهِ<br>
      ...
      <p class="text-centre">
        ...
        <br>
        For what has pleased you in the past has not lasted<br>
      ...
      <div class="div-references">
        ...
        <br>
        <span id="r2">
          [2] viz. the days, one's days, time, fate, destiny - the pre-Islāmic Arabs did not truly believe in anything except for time - time ruins all - and this sentiment carried forth into Islām and Arab perspectives on life and death and everything in between.<br>
        </span>
        <br>
        <span id="r3">
