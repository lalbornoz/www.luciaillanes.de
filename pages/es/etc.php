      <div class="div-box div-content-etc">
        <div class="div-box div-content-etc-recipes-endocrinology">
          ...
          <br>
          <h1>
            Endocrinología transfemenina<br>
            (solamente en inglés)
          </h1>
        ...
        <div class="div-box div-content-etc-kade">
          <img alt="kade" class="div-content-etc-img" id="kade" onclick="kadeClick();" src="/assets/kades/kade13.png" title="No me hagas clic!">
          <span id="kade-prev" onclick="kadePrevious();" style="cursor: pointer">⏪</span>
          <span id="kade-next" onclick="kadeNext();" style="cursor: pointer">⏩</span><br>
