      <div class="div-box div-content-etc">
        <div class="div-box div-content-etc-arabic-poems1">
          <h2>Umayyad era</h2>
          <a href="/<?php echo $inc_lang ?>/arabic_poems/amurru_3ala">I passed by the houses, the houses of Laylā</a><br>

          <h2>ʕabbāsid era</h2>
          <a href="/<?php echo $inc_lang ?>/arabic_poems/in_mittu">If I died because of you ...</a><br>
          <a href="/<?php echo $inc_lang ?>/arabic_poems/biqadri_lkaddi">Diligent conduct obtains the highest of aims</a><br>
          <a href="/<?php echo $inc_lang ?>/arabic_poems/da3_3anka">Stop blaming me, ... (NSFW)</a><br>
        ...
        <div class="div-box div-content-etc-arabic-poems2">
          <img
            alt="cats" class="div-content-etc-img"
            onclick="catsClick();" src="/arabic_poems/<?php echo $inc_lang ?>/cats.png"
            style="cursor: pointer" title="Katzen bitte unbedingt in Ruhe lassen">
          <h1 style="margin-bottom: 0">
            Übersetzte<br>
            arabische Gedichte<br>
            (primär auf Englisch)
          </h1>
          ...
          <a href="/<?php echo $inc_lang ?>/arabic_poems/lillahi_nahrun">Bei Gott, welch ein Fluss, er fließt in dem Tal!</a><br>
          <a href="/<?php echo $inc_lang ?>/arabic_poems/yaa_ghazaalan">O gazelle that shelters me, ...</a><br>
          <a href="/<?php echo $inc_lang ?>/arabic_poems/yaa_maleeh">O Handsome, O face of full moon rising</a><br>
          <a href="/<?php echo $inc_lang ?>/arabic_poems/in_kaan_wisaalak">If your love should cost me dearly ...</a><br>
          <a href="/<?php echo $inc_lang ?>/arabic_poems/man_malak_3aqlee">You that took my mind hostage</a><br>
          <a href="/<?php echo $inc_lang ?>/arabic_poems/sara2iru_la3yan">Delights that please the eye</a><br>
        </div>

        <div class="div-box div-content-etc-arabic-poems3">
          ...
          <a href="/<?php echo $inc_lang ?>/arabic_poems/nahnu_ghuraba">We are the crows of ʕakk, ʕakk!</a><br>

          <h2>Pre-modern/modern</h2>
          <a href="/<?php echo $inc_lang ?>/arabic_poems/ana_3aynee">My eyes are in endless sleeplessness ...</a><br>
